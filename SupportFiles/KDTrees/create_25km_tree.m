...
KDTree_NH = createns([lat_NH(:),lon_NH(:)]); 
KDTree_SH = createns([lat_SH(:),lon_SH(:)]); 

save('KDTree_25km.mat','KDTree','KDTree_NH','KDTree_SH','lat_X','lon_X','*_SH','*_NH'); 
